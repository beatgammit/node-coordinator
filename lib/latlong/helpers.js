(function () {
    ...
    function getZoneNumber(lat, lon) {
        ...
        zoneNumber = parseInt((lonTemp + 180) / 6, 10) + 1;
    ...
    module.exports.dmsVerify = dmsVerify;
    module.exports.dmsToDecimal = dmsToDecimal;
    module.exports.getZoneNumber = getZoneNumber;
    module.exports.UTMLetterDesignator = UTMLetterDesignator;
    module.exports.findGridLetters = findGridLetters;

    provide('helpers', module.exports);
}());
