(function () {
     ...
     */
    function utmToLatLong(UTMNorthing, UTMEasting, UTMZoneNumber, ret) {
        var xUTM,
            yUTM,
            zoneNumber,
            lonOrigin,
        ...
        phi1Rad = mu + (3 * CONSTANTS.E1 / 2 - 27 * CONSTANTS.E1 * CONSTANTS.E1 * CONSTANTS.E1 / 32 ) * Math.sin( 2 * mu) 
                       + ( 21 * CONSTANTS.E1 * CONSTANTS.E1 / 16 - 55 * CONSTANTS.E1 * CONSTANTS.E1 * CONSTANTS.E1 * CONSTANTS.E1 / 32) * Math.sin( 4 * mu)
                       + (151 * CONSTANTS.E1 * CONSTANTS.E1 * CONSTANTS.E1 / 96) * Math.sin(6 * mu);
